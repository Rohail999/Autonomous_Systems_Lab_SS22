...
role_topic = "/truck/truckRole/3"   #for publishing the data related to role assignment of Truck 3
assigned_role_topic = "/truck/truckRole/assigned"

device_token = "TRUCK_3"        #giving a human readable device ID
role=""
roleDefined = False
    ...
    while True:
        ...
        while(roleDefined == False):
            ...
            if (newPayload == True):
                ...
                newPayload = False
            time.sleep(10)
        print("Role defined to this Truck 3 is %s" %(role))
        ...
        if role == "MASTER":
            ...
            # print(truck_data)
            print("Payload for Truck 3 with Role : %s" % (role))
            print(json_string)
